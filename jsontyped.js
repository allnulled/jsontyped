...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c10 = function(first, others) { return [first].concat(others || []) },
      peg$c11 = "@",
      peg$c12 = peg$literalExpectation("@", false),
      peg$c13 = function(jspath) {
            return {
              $protocol: jspath,
            };
          },
      ...
      peg$c18 = function(protocol, host, path, query, fragment) {
            return {
              $protocol: protocol,
              $host: host,
              $path: path || "/",
